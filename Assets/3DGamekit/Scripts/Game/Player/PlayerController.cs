...
namespace Gamekit3D
{
    ...
    public class PlayerController : MonoBehaviour, IMessageReceiver
    {
        ...
        readonly int m_HashMeleeAttack1 = Animator.StringToHash("MeleeAttack2");
        ...
        void FixedUpdate()
        {
            ...
            if (m_Input.AttackL && canAttack)
                m_Animator.SetTrigger(m_HashMeleeAttack);

            m_Animator.SetFloat(m_HashStateTime, Mathf.Repeat(m_Animator.GetCurrentAnimatorStateInfo(0).normalizedTime, 1f));
            m_Animator.ResetTrigger(m_HashMeleeAttack1);

            if (m_Input.AttackR && canAttack)
                m_Animator.SetTrigger(m_HashMeleeAttack1);
        ...
        void TimeoutToIdle()
        {
            bool inputDetected = IsMoveInput || m_Input.AttackR ||m_Input.AttackL || m_Input.JumpInput;
